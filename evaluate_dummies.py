...
def evaluate_dummies(ground_truth_dir, output_dir='.', fig_name='accuracy_graph.png',
                                  verbose=False):
    ground_truth_files = listdir(ground_truth_dir)
    ground_truth_files.sort()
    transf_mats = torch.zeros(len(ground_truth_files), 2, 3)
...
print(evaluate_dummies("../data/FIRE/FIRE/gt_p"))
